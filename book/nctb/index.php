...
<h6 class="card-title"><b>Class 8</b></h6>
</div>
<div class="card-body">
<p class="card-text">We have all the books of class 8. Checkout your favourite book's PDF.</p>
<a href="c8/index.php" class="btn btn-success">Class 8 Books</a>
</div></div>

<div class="card long">
<div class="card-header" style="margin-top:10px;" >
<h6 class="card-title"><b>Class 9 - 10</b></h6>
</div>
<div class="card-body">
<p class="card-text">We have all the books of class 9 - 10. Checkout your favourite book's PDF.</p>
<a href="c9-10/index.php" class="btn btn-success">Class 9 - 10 Books</a>
</div></div>
